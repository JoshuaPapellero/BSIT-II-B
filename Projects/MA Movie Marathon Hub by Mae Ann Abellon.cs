        ...
        static void Movies()
        {
            ...
            while (!validAge)
            {
                ...
                if (int.TryParse(Console.ReadLine(), out age) && age >= 5)
                {
                    ...
                    {
                        Console.WriteLine("\nThe available category is Rated G and Rated PG. Here are some movies recommended for you.");
                    ...
                    {
                        Console.WriteLine("\nThe available category is Rated G, Rated PG and SPG. Here are some movies recommended for you.");
                        Console.WriteLine("Rated G Movies");
                        Console.WriteLine("=====================================");
                        Console.WriteLine("FILMS: \n(1) Finding Nemo, \n(2) Finding Dory, \n(3) Minions, \n(4) Frozen, \n(5) Earnest and Celestine");
                        Console.WriteLine("FAMILY FILMS: \n(6) Paddington, \n(7) Muppets Most Wanted, \n(8) Dangal");
